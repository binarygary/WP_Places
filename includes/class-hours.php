...
/**
 * WP_Places Hours class.
 *
 * @since 2.0.0
 */
class WPP_Hours extends WP_Widget {
	 ...
	 * @since  2.0.0
	 */
	protected $widget_slug = 'wp-places-hours';
	 ...
	 * @since  2.0.0
	 */
	protected static $shortcode = 'wp-places-hours';
	...
	public function __construct() {
		...
		$this->widget_name          = esc_html__( 'WP_Places Hours', 'wp-places' );
		$this->default_widget_title = esc_html__( 'WP_Places Hours', 'wp-places' );
		...
		parent::__construct(
			...
			array(
				...
				'description' => esc_html__( 'A widget boilerplate description.', 'wp-places' ),
			)
		);
	...
	public function form( $instance ) {
		...
		?>
		<p><label for="<?php echo esc_attr( $this->get_field_id( 'title' ) ); ?>"><?php esc_html_e( 'Title:', 'wp-places' ); ?></label>
		...
		<p><label for="<?php echo esc_attr( $this->get_field_id( 'text' ) ); ?>"><?php esc_html_e( 'Text:', 'wp-places' ); ?></label>
		...
		<p class="description"><?php esc_html_e( 'Basic HTML tags are allowed.', 'wp-places' ); ?></p>
		<?php
	}
}
 ...
 * @return void
 */
function wp_places_register_hours() {
	register_widget( 'WPP_Hours' );
}
add_action( 'widgets_init', 'wp_places_register_hours' );
