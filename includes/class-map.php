 ...
 * @since 2.0.0
 */
class WPP_Map extends WP_Widget {
	 ...
	 * @since  2.0.0
	 */
	protected $widget_slug = 'wp-places-map';
	 ...
	 * @since  2.0.0
	 */
	protected static $shortcode = 'wp-places-map';
	...
	public function __construct() {
		...
		$this->widget_name          = esc_html__( 'WP_Places Map', 'wp-places' );
		$this->default_widget_title = esc_html__( 'WP_Places Map', 'wp-places' );
 ...
 * @return void
 */
function wp_places_register_map() {
	register_widget( 'WPP_Map' );
}
add_action( 'widgets_init', 'wp_places_register_map' );
